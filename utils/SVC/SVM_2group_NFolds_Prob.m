function [Accuracy, Sensitivity, Specificity] = SVM_2group_NFolds_Prob(Subjects_Data, Subjects_Label, Fold_Quantity, Pre_Method, ResultantFolder, Permutation_Flag)
%
% Subject_Data:
%           m*n matrix
...
[Splited_Data, Splited_Data_Label, Origin_ID_Cell] = Split_NFolds_Prob(Subjects_Data, Subjects_Label, Fold_Quantity);
...
Group1_Index = find(Subjects_Label(Origin_ID) > 0);
