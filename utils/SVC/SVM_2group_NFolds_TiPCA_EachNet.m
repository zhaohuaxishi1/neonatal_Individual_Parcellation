function [Accuracy, Sensitivity, Specificity] = SVM_2group_NFolds_TiPCA_EachNet(Subjects_Data, Subjects_Label,randNet,Netnum,Netfea, Fold_Quantity, Pre_Method,ResultantFolder, Permutation_Flag)
%
% Subject_Data:
%           m*n matrix
...
for i = 1:Fold_Quantity
    ...
    Training_data_voxel = Training_all_data;
    Test_data_voxel = test_data;
